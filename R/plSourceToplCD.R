...
#'
#'\code{plSourceToplCD} computes corrected pl from mass functions as source outputs.
#' @param mSource : mass functions as source outputs.
#' @param beta : reliability vector of contextual discounting (CD).
